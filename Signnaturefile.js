...
export const  getBLOBFileHeader = (url, blob, callback) => {
  ...
  export const getRemoteFileHeader = (url, callback) =>{
  ...
  export const headerCallback = (url, headerString) => {
    printHeaderInfo(url, headerString);
  }
  
  export const remoteCallback = (url, blob) =>{
    printImage(blob);
    getBLOBFileHeader(url, blob, headerCallback);
  }
  
  export const printImage = (blob) => {
  ...
  export const mimeType = (headerString) => {
    switch (headerString) {
      case "89504e47":
        type = "image/png";
        break;
  ...
  export const printHeaderInfo = (url, headerString) => {
